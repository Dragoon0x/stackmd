...
export function analyze(extracted) {
  ...
  const data = {
    ...
    // V2 extraction passes (37-64)
    cookieConsent: extracted.cookieConsent || null,
    loadingPatterns: extracted.loadingPatterns || null,
    tablePatterns: extracted.tablePatterns || null,
    tabPatterns: extracted.tabPatterns || null,
    accordionPatterns: extracted.accordionPatterns || null,
    breadcrumbPatterns: extracted.breadcrumbPatterns || null,
    toastPatterns: extracted.toastPatterns || null,
    avatarPatterns: extracted.avatarPatterns || null,
    emptyStatePatterns: extracted.emptyStatePatterns || null,
    paginationPatterns: extracted.paginationPatterns || null,
    searchDeep: extracted.searchDeep || null,
    filterSortPatterns: extracted.filterSortPatterns || null,
    sidebarPatterns: extracted.sidebarPatterns || null,
    testimonialPatterns: extracted.testimonialPatterns || null,
    faqPatterns: extracted.faqPatterns || null,
    codeBlockPatterns: extracted.codeBlockPatterns || null,
    timelinePatterns: extracted.timelinePatterns || null,
    cardVariants: extracted.cardVariants || null,
    statusPatterns: extracted.statusPatterns || null,
    progressPatterns: extracted.progressPatterns || null,
    bannerPatterns: extracted.bannerPatterns || null,
    pwaCapabilities: extracted.pwaCapabilities || null,
    storagePatterns: extracted.storagePatterns || null,
    securitySignals: extracted.securitySignals || null,
    aboveFold: extracted.aboveFold || null,
    i18nSignals: extracted.i18nSignals || null,
    whitespaceRhythm: extracted.whitespaceRhythm || null,
    microInteractions: extracted.microInteractions || null,
  };
